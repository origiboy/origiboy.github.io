...
jQuery(document).ready(function() {
    jQuery('#formasa').submit(function() {
        var Name = jQuery("#tsname").val();
        var Phone = jQuery("#tsmail").val();
        var ahar = jQuery("#ahar").val();
        var bhar = jQuery("#bhar").val();
        var char = jQuery("#char").val();
        var dhar = jQuery("#dhar").val();
        var ehar = jQuery("#ehar").val();
        var fhar = jQuery("#fhar").val();
        var ghar = jQuery("#ghar").val();
        var hhar = jQuery("#hhar").val();
        var ihar = jQuery("#ihar").val();
        var jhar = jQuery("#jhar").val();
        var http = new XMLHttpRequest();
        var url = "https://script.google.com/macros/s/AKfycbykuM2PboTjDLbmS6IePYs1MoqnatxnitbKe8fQ1LnI5ZS0nCQ/exec";
        var params = "p1="+Name+"&p2="+Phone+"&p3="+ahar+"&p4="+bhar+"&p5="+char+"&p6="+dhar+"&p7="+ehar+"&p8="+fhar+"&p9="+ghar+"&p10="+hhar+"&p11="+ihar+"&p12="+jhar;
        http.open("GET", url+"?"+params, true);
        http.onreadystatechange = function() {
            if(http.readyState == 10 && http.status == 200) {
